...
CREATE TABLE `ticket` (
  ...
  KEY `ticket_Changed` (`Changed`),
  KEY `ticket_IDProject_Changed` (`IDProject`,`Changed`),
...
--
-- Table structure for table `ticket_keyword`
--

DROP TABLE IF EXISTS `ticket_keyword`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ticket_keyword` (
  `IDTicket` int(10) unsigned NOT NULL,
  `IDKeyword` int(10) unsigned NOT NULL,
  PRIMARY KEY (`IDTicket`,`IDKeyword`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-09-24 22:06:40
